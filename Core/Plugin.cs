...
public class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        // PID Loops
        ConfPidAlt = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "01. Altitude > VS",
            new PIDTuning(0.5, 0, 3), "Altitude > Vertical Speed");

        ConfPidVs = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "02. VS > Pitch",
            new PIDTuning(2.44967771875362, 2.31068044043631, 0.549968619394224), "Vertical Speed > Pitch Angle");

        ConfPidPitch = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "03. Pitch > Pitch Rate",
            new PIDTuning(0.0329026146189137, 5.7512084040881, 0.12329376291698, smoothIn: 0.5, smoothOut: 0.5), "Pitch Angle > Pitch Rate");

        ConfPidRoll = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "05. Roll > Roll Rate",
            new PIDTuning(1, 0, 0), "Roll > Roll rate");

        ConfPidRollRate = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "06. Roll Rate > Stick",
            new PIDTuning(0.004, 0.3851634589019024, 0), "Roll rate > Stick");

        ConfPidCrs = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "07. Course > Course Rate",
            new PIDTuning(1, 30, 0, clegg: true), "Course Error > Course Rate");

        ConfPidCrsRate = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "07. Course Rate > Roll",
            new PIDTuning(1, 30, 0, clegg: true), "Course Rate > Roll Angle");

        ConfPidSpd = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "08. Speed > Throttle",
            new PIDTuning(0.276635855846017, 4.55835278395057, 0.486418840935585, 5), "Speed Error > Throttle");

        ConfPidGcas = PIDTuningBinder.Bind(Config, "PID (advanced settings, don't change unless you know what a PID controller is)", "09. G-Force > Stick",
